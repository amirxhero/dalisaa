...
<section class="relative overflow-hidden bg-ink-900 py-12 sm:py-16">
    ...
    >
    <div class="absolute inset-0 bg-gradient-to-t from-ink-900 via-ink-900/90 to-ink-900/70"></div>
    ...
    <div class="relative mx-auto max-w-4xl px-6 text-center text-white">
        ...
        <div class="flex flex-wrap items-center justify-center gap-4">
            <span class="inline-flex items-center gap-2 rounded-full border border-white/15 px-4 py-2 text-xs text-white/70">
                <x-icon name="clock" class="h-4 w-4 text-brand-400" />
                ساعت کار سایت ۹ الی ۱۹
            </span>
            <a href="#" class="inline-flex items-center gap-1.5 rounded-full bg-brand-500 px-5 py-2.5 text-xs font-bold text-white transition-colors hover:bg-brand-600">
                بیشتر
