...
<header class="sticky top-0 z-40 bg-white shadow-sm">
    ...
    <div class="lg:hidden">
        <div class="flex items-center justify-between px-4 py-3">
            <a href="{{ route('home') }}" class="block h-9 w-9 shrink-0">
                <x-logo variant="icon" class="h-9 w-9" />
            </a>

            <a href="{{ route('special-offers.index') }}" class="flex h-9 shrink-0 items-center gap-1.5 rounded-full bg-brand-50 px-3 text-xs font-semibold text-brand-500 transition-all duration-200 hover:bg-brand-100 active:scale-95">
                <x-icon name="fire" class="h-4.5 w-4.5 shrink-0 animate-pulse text-brand-500" />
                <span class="whitespace-nowrap">شگفت‌انگیز</span>
            </a>
        </div>
