...
@php $breadcrumbs = ['مقالات', 'ایجاد']; @endphp
    ...
    <div class="flex flex-col gap-5 lg:flex-row lg:items-start">
        ...
        <div class="flex-1 space-y-4">
            ...
            <div class="overflow-hidden rounded-2xl bg-white shadow-sm"
                 x-data="richEditor({ value: @js(old('content', '')), uploadUrl: '{{ route('admin.post-images.store') }}' })">
                ...
                <div class="flex flex-wrap items-center gap-0.5 border-b border-gray-100 bg-gray-50/80 px-3 py-2">
                    ...
                    <button type="button" @click="cmd('highlight')" :class="isActive('highlight') && 'is-on'" class="editor-tb-btn" title="هایلایت" style="background-color: inherit">
                    ...
                    <button type="button" @click="cmd('codeBlock')" :class="isActive('codeBlock') && 'is-on'" class="editor-tb-btn font-mono text-xs" title="کد">
                        &lt;/&gt;
                    </button>
                ...
                {{-- Hidden input carries the HTML to the form --}}
                <input type="hidden" name="content" x-ref="hiddenContent" value="{{ old('content') }}">
            </div>
        ...
        <div class="w-full space-y-4 lg:w-72">
            ...
            <x-admin.section title="انتشار">
                <div class="space-y-3 p-4">
                    ...
                    <x-admin.jalali-date-input name="published_at" id="published_at" label="تاریخ انتشار (اختیاری)" :value="old('published_at')" />
                    <div class="border-t border-gray-100 pt-3">
                        ...
                        <a href="{{ route('admin.posts.index') }}" class="admin-btn-secondary mt-2 w-full justify-center">انصراف</a>
                    </div>
                </div>
            </x-admin.section>
            ...
            <x-admin.section title="تصویر شاخص">
                <div class="p-4">
                    <div class="rounded-xl border-2 border-dashed border-gray-200 p-5 text-center hover:border-indigo-200">
                        ...
                        <p class="mt-2 text-xs text-gray-400">JPG، PNG · حداکثر ۴ مگابایت</p>
                    </div>
            ...
            <x-admin.section title="خلاصه مقاله">
                <div class="p-4">
                    <textarea name="excerpt" rows="3" maxlength="600"
                              placeholder="خلاصه‌ای کوتاه از مقاله برای نمایش در لیست..."
                              class="admin-input resize-none">{{ old('excerpt') }}</textarea>
            ...
            <x-admin.section title="آدرس URL">
                <div class="p-4">
                    ...
                    <p class="mt-1 text-xs text-gray-400">خالی بگذارید تا خودکار ساخته شود</p>
                </div>
            </x-admin.section>
